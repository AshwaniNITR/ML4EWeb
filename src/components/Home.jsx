...
function NeuralStructure({ position = [0, 0, 0], color = "#00faff", nodeCount = 8 }) {
  const nodes = useRef([]);
...
export default function Home() {
  ...
  >
    <motion.h1
      ...
      transition={{ duration: 1, ease: "easeOut" }}
      className="text-4xl  md:text-5xl font-bold text-cyan-400 drop-shadow-[0_0_15px_#00faff]"
    ...
    <motion.p
      ...
      className="mt-2 text-lg md:text-xl text-blue-300 drop-shadow-[0_0_10px_#00d9ff]"
      style={{ fontFamily: "Roboto, sans-serif" }}
    >
